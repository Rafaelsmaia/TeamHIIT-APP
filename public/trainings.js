      ...
      trainings: [
        {
          ...
          modules: [
            ...
            { title: "Treino 3", videoUrl: "https://youtu.be/mQbxww1Pv40" },
            { title: "Treino 4", videoUrl: "https://youtu.be/DRLqOoxgtb0" },
      ...
      trainings: [
        {
          ...
          modules: [
            ...
            { title: "Treino 4", videoUrl: "https://youtu.be/-XSkWJVRnzY" },
            { title: "Treino 5", videoUrl: "https://youtu.be/Cdaoh6i6AIw" },
            { title: "Treino 6", videoUrl: "https://youtu.be/1gsIqn9zgyg" },
            { title: "Treino 7", videoUrl: "https://youtu.be/BE6fMnkG9vY" },
            { title: "Treino 8", videoUrl: "https://youtu.be/Fw78EtZnhgU" },
            { title: "Treino 9", videoUrl: "https://youtu.be/6PUm-LD7iGM" },
            { title: "Treino 10", videoUrl: "https://youtu.be/N4da64kC5vs" },
            { title: "Treino 11", videoUrl: "https://youtu.be/ibE9AK_RVhQ" },
            { title: "Treino 12", videoUrl: "https://youtu.be/bb1IHzFrjzo" },
            { title: "Treino 13", videoUrl: "https://youtu.be/ARuwvySaC6k" },
            { title: "Treino 14", videoUrl: "https://youtu.be/DapUrU5trVE" },
            { title: "Treino 15", videoUrl: "https://youtu.be/JdAD648Bi5s" },
            { title: "Treino 16", videoUrl: "https://youtu.be/pc4jDn9vU9s" },
            { title: "Treino 17", videoUrl: "https://youtu.be/R5Jc0uLFQDk" },
            { title: "Treino 18", videoUrl: "https://youtu.be/UlEobtioU_c" },
            { title: "Treino 19", videoUrl: "https://youtu.be/mAgveJ8clQE" },
            { title: "Treino 20", videoUrl: "https://youtu.be/HD0jCFntjoI" },
            { title: "Treino 21", videoUrl: "https://youtu.be/HWIC1wgFb_4" },
            { title: "Treino 22", videoUrl: "https://youtu.be/_xXeiTEfv3E" },
            { title: "Treino 23", videoUrl: "https://youtu.be/bSel8BYw-aE" },
            { title: "Treino 24", videoUrl: "https://youtu.be/mwJHky6tMGE" },
            { title: "Treino 25", videoUrl: "https://youtu.be/awfUG_87b1M" },
        ...
        {
          id: "pernas-gluteos-equipamentos",
          ...
          modules: [
            ...
            { title: "Treino 4", videoUrl: "https://youtu.be/bWbeOq2uc30" },
            { title: "Treino 5", videoUrl: "https://youtu.be/H02jIYqUyMg" },
            { title: "Treino 6", videoUrl: "https://youtu.be/lW-M5uERtvY" },
        ...
        {
          id: "treino-superiores",
          title: "TREINOS PARA SUPERIORES",
          duration: "13 treinos",
          level: "Intermediário",
          categories: ["Equipamentos"],
      ...
      trainings: [
        ...
        },
        {
          ...
          modules: [
            ...
            { title: "Semana 1 - Treino 4", videoUrl: "https://youtu.be/RLm5c40E2Wg" },
            { title: "Semana 1 - Treino 5", videoUrl: "https://youtu.be/BAdp1nGyJC8" },
            { title: "Semana 2 - Treino 1", videoUrl: "https://youtu.be/HZf8uxAw5Hw" },
            { title: "Semana 2 - Treino 2", videoUrl: "https://youtu.be/XqYZIfW1D94" },
            { title: "Semana 2 - Treino 3", videoUrl: "https://youtu.be/wB0W4OmYnGU" },
            { title: "Semana 2 - Treino 4", videoUrl: "https://youtu.be/ttlcLntZZ7k" },
            { title: "Semana 2 - Treino 5", videoUrl: "https://youtu.be/cuPs8kWtlGQ" },
            { title: "Semana 3 - Treino 1", videoUrl: "https://youtu.be/zN9Tkn5jPsM" },
            { title: "Semana 3 - Treino 2", videoUrl: "https://youtu.be/uBuFPxIVXMY" },
            { title: "Semana 3 - Treino 3", videoUrl: "https://youtu.be/52mAUiW0TSQ" },
            { title: "Semana 3 - Treino 4", videoUrl: "https://youtu.be/o8T7Gdm4hPg" },
            { title: "Semana 3 - Treino 5", videoUrl: "https://youtu.be/43J6yaGa3KE" },
            { title: "Semana 4 - Treino 1", videoUrl: "https://youtu.be/XIyblCJx8Gw" },
            { title: "Semana 4 - Treino 2", videoUrl: "https://youtu.be/BmDhahUDlew" },
            { title: "Semana 4 - Treino 3", videoUrl: "https://youtu.be/SxW9QlBdlk0" },
            { title: "Semana 4 - Treino 4", videoUrl: "https://youtu.be/wLbp-FoqJBk" },
            { title: "Semana 4 - Treino 5", videoUrl: "https://youtu.be/P5UVeJm_sXo" }
          ]
        },
        {
          id: "todos-em-pe",
          title: "MÓDULO TODO EM PÉ",
          duration: "4 semanas",
          level: "Adaptado",
          categories: ["Adaptado"],
          ...
          modules: [
            ...
            { title: "Semana 2 - Treino 4", videoUrl: "https://youtu.be/Hj9-_ru7ETE" },
            { title: "Semana 2 - Treino 5", videoUrl: "https://youtu.be/3LOkP7L-0gw" },
            { title: "Semana 2 - Treino 6", videoUrl: "https://youtu.be/6SowpGPI1eI" },
            { title: "Semana 3 - Treino 1", videoUrl: "https://youtu.be/D84fu-NYmLE" },
            { title: "Semana 3 - Treino 2", videoUrl: "https://youtu.be/ugPWvvi1kFs" },
            { title: "Semana 3 - Treino 3", videoUrl: "https://youtu.be/9bmtPMi0Bp8" },
            { title: "Semana 3 - Treino 4", videoUrl: "https://youtu.be/6BTYTSYgumQ" },
            { title: "Semana 3 - Treino 5", videoUrl: "https://youtu.be/e-dxRpuQ9Ag" },
            { title: "Semana 3 - Treino 6", videoUrl: "https://youtu.be/Uo6zYdbFKcw" },
            { title: "Semana 4 - Treino 1", videoUrl: "https://youtu.be/2AfvGmdNrhY" },
            { title: "Semana 4 - Treino 2", videoUrl: "https://youtu.be/wjyT6gAAXdY" },
            { title: "Semana 4 - Treino 3", videoUrl: "https://youtu.be/kZy_kSdArI4" },
            { title: "Semana 4 - Treino 4", videoUrl: "https://youtu.be/cE3VtqUXl54" },
            { title: "Semana 4 - Treino 5", videoUrl: "https://youtu.be/ZLYbEcbC61g" },
            { title: "Semana 4 - Treino 6", videoUrl: "https://youtu.be/lMMtJTLEcbQ" }
          ]
        }
      ]
    },
      ...
      trainings: [
        {
          ...
          modules: [
            ...
            { title: "Treino 4", videoUrl: "https://youtu.be/L9KY4BeT4oo" },
            { title: "Treino 5", videoUrl: "https://youtu.be/CEEeKS73EFk" },
            { title: "Treino 6", videoUrl: "https://youtu.be/kmoqnrzrgeY" },
            { title: "Treino 7", videoUrl: "https://youtu.be/5xRYb5L7XXw" },
            { title: "Treino 8", videoUrl: "https://youtu.be/iVCM_EdJRC8" },
            { title: "Treino 9", videoUrl: "https://youtu.be/ZycohTJ4I_8" },
            { title: "Treino 10", videoUrl: "https://youtu.be/PsXnlxvjt1w" },
            { title: "Treino 11", videoUrl: "https://youtu.be/DS4isgAOFWE" },
            { title: "Treino 12", videoUrl: "https://youtu.be/49_IZNnEr3A" },
            { title: "Treino 13", videoUrl: "https://youtu.be/UlkPtl81rHA" },
            { title: "Treino 14", videoUrl: "https://youtu.be/vYmohnoaKJ0" }
          ]
        },
        {
